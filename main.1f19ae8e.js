...
var _default = {
  ...
  computed: {
    pageCount: function pageCount() {
      var length = this.usersList.length;
      var size = this.maxPages;
      return Math.ceil(length / size);
    },
    paginatedData: function paginatedData() {
      var start = this.pageNumber * this.maxPages;
      var end = start + this.maxPages;
      return this.usersList.slice(start, end);
    }
  },
  methods: {
    sortUsers: function sortUsers(key) {
      var _this = this;

      var resetSortedStatus = function resetSortedStatus() {
        var _arr = Object.keys(_this.sortedByDescending);

        for (var _i = 0; _i < _arr.length; _i++) {
          var _key = _arr[_i];
          _this.sortedByDescending[_key] = false;
        }
      };
...
exports.default = _default;
        var $6aef71 = exports.default || module.exports;
      
      if (typeof $6aef71 === 'function') {
        $6aef71 = $6aef71.options;
      }
    
        /* template */
        Object.assign($6aef71, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container" }, [
    _c("h1", { staticClass: "heading" }, [_vm._v("Users")]),
    _vm._v(" "),
    _c(
      "table",
      { staticClass: "users" },
      [
        _c("tr", { staticClass: "users__headings" }, [
          _c(
            "th",
            {
              staticClass: "users__heading",
              on: {
        ...
        _vm._l(_vm.paginatedData, function(item) {
          return _c("tr", { staticClass: "users__row" }, [
            _c("td", { staticClass: "users__cell" }, [_vm._v(_vm._s(item.id))]),
            _vm._v(" "),
            _c("td", { staticClass: "users__cell" }, [
    ...
    _c("div", { staticClass: "pagination" }, [
      _c(
        "button",
        {
          staticClass: "pagination__button pagination__button--previous",
      ...
      _vm._v(" "),
      _c("p", { staticClass: "pagination__counter" }, [
        _vm._v(
          "Page " +
      ...
      _c(
        "button",
        {
          staticClass: "pagination__button pagination__button--next",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6aef71', $6aef71);
          } else {
            api.reload('$6aef71', $6aef71);
          }
        }
